...
func calcHandler(w http.ResponseWriter, r *http.Request) {
    ...
    // Added bounds check to prevent out-of-range slice access (fixes potential panic when idx is invalid)
    // and to return a 400 Bad Request when the provided index is negative or exceeds the number of elements.
